...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "19b30cd0-95aa-4f5c-9d9d-edb53870de08",
...
const _lazy_ICrIDz = () => import('../routes/api/tasks/_id_.delete.mjs');
const _lazy_UnbnBm = () => import('../routes/api/tasks/_id_.patch.mjs');
const _lazy_CpJ79i = () => import('../routes/api/index.get.mjs');
const _lazy_F5IlYl = () => import('../routes/api/index.post.mjs');
const _lazy_SLcelR = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/tasks/:id', handler: _lazy_ICrIDz, lazy: true, middleware: false, method: "delete" },
  { route: '/api/tasks/:id', handler: _lazy_UnbnBm, lazy: true, middleware: false, method: "patch" },
  { route: '/api/tasks', handler: _lazy_CpJ79i, lazy: true, middleware: false, method: "get" },
  { route: '/api/tasks', handler: _lazy_F5IlYl, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_SLcelR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SLcelR, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, defu as A, withTrailingSlash as B, withoutTrailingSlash as C, handler as D, defineRenderHandler as a, getQuery as b, createError$1 as c, defineEventHandler as d, getRouteRules as e, getResponseStatusText as f, getRouterParam as g, getResponseStatus as h, useNitroApp as i, joinRelativeURL as j, hasProtocol as k, isScriptProtocol as l, joinURL as m, sanitizeStatusCode as n, getContext as o, createHooks as p, isEqual as q, readBody as r, setResponseStatus as s, stringifyParsedURL as t, useRuntimeConfig as u, stringifyQuery as v, withQuery as w, parseQuery as x, toRouteMatcher as y, createRouter$1 as z };
