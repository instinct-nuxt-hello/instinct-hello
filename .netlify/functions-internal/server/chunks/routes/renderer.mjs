...
import { j as joinRelativeURL, u as useRuntimeConfig, a as defineRenderHandler, b as getQuery, c as createError, e as getRouteRules, f as getResponseStatusText, h as getResponseStatus, i as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"A clean, fast task manager."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Instinct Tasks"};
